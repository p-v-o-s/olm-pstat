...
void setup(){
  ...
  SCmd.addCommand("IRANGE", setCurrentRangeCommand);
...
void setSweepStartCommand(){
  ...
  if (arg != NULL)
  {
    ...
    {
      Serial.print(F("### Error: VSWEEP_START must have ("));
      Serial.print(V_MIN,3);
  ...
  {
    Serial.println(F("### Error: VSWEEP_START - requires 1 argument (float v_start) ###"));
  }
}
...
void setSweepEndCommand(){
  ...
  if (arg != NULL)
  {
    ...
    {
      Serial.print(F("### Error: VSWEEP_END must have ("));
      Serial.print(V_MIN,3);
  ...
  {
    Serial.println(F("### Error: VSWEEP_END - requires 1 argument (float v_end) ###"));
  }
}
...
void setCurrentRangeCommand(){
  ...
  if (arg != NULL)
  {
    ...
    {
      Serial.print(F("### Error: IRANGE must have ("));
  ...
  {
    Serial.println(F("### Error: IRANGE- requires 1 argument (int range_index) ###"));
  }
}
